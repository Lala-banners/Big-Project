...
public class InteractableObject : MonoBehaviour
{
	...
	[Space] [SerializeField, Tooltip("The point on the interactable object we want to grab, if not set, will use origin")]
	private Transform attachPoint;

	[Space] [Header("Interaction Events for interactable objects")]
	...
	private InteractEventArgs GenerateArgs(XRController _controller) => new InteractEventArgs(_controller, rigidbody, collider);

	public void OnObjectGrabbed(XRController _controller)
	{
	...
	public void OnObjectReleased(XRController _controller)
	{
		//If the object is grabbable or if it is any input source
		if(isGrabbable && (_controller.InputSource == allowedSource || allowedSource == SteamVR_Input_Sources.Any))
	...
	public void OnObjectTouched(XRController _controller)
	{
	...
	public void OnObjectStopTouching(XRController _controller)
	{
	...
	public void OnObjectUsed(XRController _controller)
	{
	...
	public void OnObjectStopUsing(XRController _controller)
	{
