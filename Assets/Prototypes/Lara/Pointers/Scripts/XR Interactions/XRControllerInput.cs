...
public class XRControllerInput : MonoBehaviour
{
	...
	[Header("Steam Actions")] [SerializeField, Tooltip("Pointer action in VR")]
	private SteamVR_Action_Boolean pointer;

	[SerializeField, Tooltip("Teleport action in VR")]
	private SteamVR_Action_Boolean teleport;

	[SerializeField, Tooltip("Use action in VR")]
	private SteamVR_Action_Boolean interact;

	[SerializeField, Tooltip("Grab action in VR")]
	private SteamVR_Action_Boolean grab;

	[SerializeField, Tooltip("Touch pad in VR")]
	...
	private VRInputEvent onPointerPressed = new VRInputEvent();
	...
	public void Initialise(XRController _controller)
	{
