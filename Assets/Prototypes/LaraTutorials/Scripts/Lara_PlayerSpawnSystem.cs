...
/// </summary>
public class Lara_PlayerSpawnSystem : NetworkBehaviour
{
    ...
    public override void OnStartServer() => Lara_NetworkManager.OnServerReadied += SpawnPlayer;

    //When this obj gets destroyed, despawn player
    [ServerCallback]
    private void OnDestroy() => Lara_NetworkManager.OnServerReadied -= SpawnPlayer;
