...
public class PickUp : MonoBehaviour
{
	...
	{
		hidingSpot1.gameObject.GetComponent<SphereCollider>().enabled = false;
		hidingSpot2.gameObject.GetComponent<SphereCollider>().enabled = false;
		hidingSpot3.gameObject.GetComponent<SphereCollider>().enabled = false;
	...
	{
		hidingSpot1.gameObject.GetComponent<SphereCollider>().enabled = true;
		hidingSpot2.gameObject.GetComponent<SphereCollider>().enabled = true;
		hidingSpot3.gameObject.GetComponent<SphereCollider>().enabled = true;
